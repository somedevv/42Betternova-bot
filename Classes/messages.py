...
class ErrorMessages:
    ...
    USER_FREEZE_STATUS = (
        'Hi <b>{}</b>,\n' + 
        'you are currently in freeze status, you can\'t use the bot until you are unfrozen'
        )
    BOT_FREEZE_STATUS = (
        'Hi <b>{}</b>,\n' + 
        'im currently in freeze status, you can\'t use the bot until i am unfrozen 🥶'
        )
